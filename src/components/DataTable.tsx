  ...
  return (
    <Card className="animate-fade-up overflow-hidden">
      <div className="flex items-center justify-between gap-2 border-b border-[var(--border)] p-4">
        <div>
          <h3 className="text-sm font-semibold">רשומות ({formatNumber(records.length)})</h3>
          <p className="text-xs text-[var(--text-muted)]">לחיצה על כותרת עמודה ממיינת את הטבלה</p>
        </div>
        <button
          type="button"
