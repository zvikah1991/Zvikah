      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <label className="flex items-center gap-2 text-xs text-[var(--text-secondary)]">
          ...
          <input
            ...
            className="w-24 rounded-lg border border-[var(--border)] bg-[var(--surface)] px-2 py-1 text-sm tabular-nums outline-none"
          />
        </label>
        ...
        <div className="ms-auto flex flex-wrap items-center gap-2">
          ...
          >
            ...
            {isUploading ? "מעלה…" : "העלאת דוח CSV"}
          </button>
        </div>
      </div>
      ...
      {pasteOpen && (
        <div className="flex flex-col gap-2 rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-3">
          <p className="text-xs text-[var(--text-muted)]">
            בגוגל אדס: לוחצים על טבלת הביצועים היומיים (עמודות תאריך ועלות), מסמנים הכל (Ctrl+A) ומעתיקים (Ctrl+C) — ואז מדביקים כאן.
          </p>
          <textarea
            value={pasteText}
            ...
            dir="ltr"
            rows={5}
            placeholder="Day	Cost	Clicks	Impr.	Calls…"
